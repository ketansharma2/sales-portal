...
export default function CRMDomesticTargetPage() {
  ...
  // --- MOCK DATA: HOD ASSIGNED TARGETS TO CRM ---
  const myTargetsData = [
      { 
        id: 101, year: "2026", month: "April", workingDays: "22", sector: "Domestic", assignedBy: "Rajesh Kumar (HOD)", assignedRole: "Head of Department",
        guideline: "Ensure 100% SLA compliance for top volume hiring domestic accounts.", 
        kpi_metric: "SLA Compliance", frequency: "Monthly", 
        target: 100, achieved: 98 
      },
      { 
        id: 102, year: "2026", month: "April", workingDays: "22", sector: "Domestic", assignedBy: "Rajesh Kumar (HOD)", assignedRole: "Head of Department",
        guideline: "Clear pending recruitment billing for Q1.", 
        kpi_metric: "Revenue Billed", frequency: "Monthly", 
        target: 12000000, achieved: 9500000 
      }
  ];
  ...
  const handleOpenModal = (item = null) => {
    if (item && item.id) {
        ...
        setForm({
            ...
            department: "Delivery", sector: "Domestic", role: "Team Leader (TL)", assignedTo: item.assignedTo || "",
            targetList: [{ 
        ...
        setForm({
            ...
            department: "Delivery", sector: "Domestic", role: "Team Leader (TL)", assignedTo: "",
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-4 gap-4">
             <div>
                <h1 className="text-2xl font-black text-[#103c7f] uppercase tracking-tight flex items-center gap-2">
                    <CheckCircle size={24} className="text-emerald-500"/> Domestic Targets (CRM)
                </h1>
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-4 flex justify-between items-center text-white bg-emerald-700">
                    <h3 className="font-bold uppercase tracking-widest text-sm flex items-center gap-2">
                        ...
                        {editId ? "Edit Team Target" : "Assign Domestic Target to Team Leader"}
                    </h3>
