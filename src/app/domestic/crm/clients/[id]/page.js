...
return (
    ...
    {/* ================= COLUMN 2: CONVERSATION HUB (YOUR EXACT CODE + VIEW ALL BUTTONS) ================= */}
      <div className="flex-[1.6] bg-gray-50 border-r border-gray-200 flex flex-col min-w-[400px]">
         
         {/* Section Header */}
         <div className="px-5 py-3 border-b border-gray-200 bg-white flex justify-between items-center shrink-0 h-16 shadow-sm z-10">
            <div>
            ...
            <div className="flex gap-2">
               <button onClick={() => setIsContactModalOpen(true)} className="flex items-center gap-1 bg-white border border-gray-200 text-gray-600 px-2 py-1.5 rounded text-[10px] font-bold hover:bg-gray-50 shadow-sm">
                  <Plus size={12}/> Contact
               </button>
               <button className="flex items-center gap-1 bg-[#103c7f] text-white px-3 py-1.5 rounded text-[10px] font-bold hover:bg-blue-900 shadow-md transition-all">
        ...
        {/* 2. Activity Timeline */}
            <div className="flex-1 flex flex-col min-h-0">
               <div className="flex justify-between items-end mb-3">
                  ...
                  {/* VIEW ALL BUTTON */}
                  <button onClick={() => setIsAllHistoryOpen(true)} className="text-[10px] font-bold text-[#103c7f] hover:underline flex items-center gap-1">
                  ...
                  <div className="space-y-4 pb-10">
                     {currentBranchData.logs.map(log => (
                        <div key={log.id} className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                           {/* Left Accent Line based on type */}
    ...
    {/* ================= COLUMN 3: OPERATIONS HUB (1 Flex) ================= */}
      <div className="flex-1 bg-white flex flex-col min-w-[350px]">
         
         {/* Section Header */}
         <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 shrink-0 h-16">
            <div>
            ...
            <div className="flex gap-2">
               <button className="flex items-center gap-1 bg-white border border-gray-200 text-gray-600 px-3 py-1.5 rounded-lg text-[10px] font-bold hover:bg-gray-50 shadow-sm">
                  <Plus size={12}/> Tracker
               </button>
               <button className="flex items-center gap-1 bg-[#103c7f] text-white px-3 py-1.5 rounded-lg text-[10px] font-bold hover:bg-blue-900 shadow-md transition-all">
                  <Plus size={12}/> Req
               </button>
            </div>
         </div>
         ...
         <div className="flex-1 overflow-y-auto p-6 custom-scrollbar space-y-8">
            ...
            {/* 2. Trackers List (SCROLLABLE & MORE DATA) */}
            <section className="flex-1 flex flex-col min-h-0">
              <div className="flex justify-between items-end mb-3">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Tracker History</label>
                  
                  {/* View All Button */}
                  <button className="text-[10px] font-bold text-[#103c7f] hover:underline flex items-center gap-1">
                        ...
                        <div key={t.id} className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-all">
                           ...
                           <div className="bg-gray-50 px-4 py-3 border-b border-gray-100 flex justify-between items-center">
                              <div className="flex items-center gap-3">
                                 <div>
                                    <h5 className="text-xs font-black text-gray-800">{t.name}</h5>
                                    <p className="text-[9px] text-gray-500 font-medium">Shared: <span className="font-bold">{t.date}</span></p>
                                 </div>
                              </div>
                           ...
                           <div className="px-4 py-2.5 border-t border-gray-100 bg-gray-50/30 flex justify-between items-center">
                              <div className="flex items-center gap-2 overflow-hidden">
                                 ...
                                 <p className="text-[10px] text-gray-600 font-medium italic truncate max-w-[150px]">
                                    "{t.feedback}"
                                 </p>
                              </div>
                           </div>
