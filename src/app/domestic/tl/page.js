                ...
                <div className="overflow-x-auto custom-scrollbar">
                    <table className="w-full text-left border-collapse min-w-[1300px]">
                        <thead className="bg-[#103c7f] text-white text-[10px] uppercase font-bold sticky top-0 z-10">
                            <tr>
                                <th className="p-2 border-r border-blue-800 w-6 text-center">#</th>
                                ...
                                <th className="p-2 border-r border-blue-800 min-w-[120px]"><div className="flex items-center gap-1.5 text-yellow-300"><Users size={12}/> Recruiter & Slot</div></th>
                                
                                {/* Profile & JD Column */}
                                <th className="p-2 border-r border-blue-800 min-w-[160px]"><div className="flex items-center gap-1.5"><Briefcase size={12}/> Profile & JD</div></th>
                                
                                <th className="p-2 border-r border-blue-800 text-center"><div className="flex items-center justify-center gap-1.5"><IndianRupee size={12}/> Pkg / Req</div></th>
                                ...
                                <th className="p-2 border-r border-blue-800 text-center"><div className="flex items-center justify-center gap-1.5"><UserCheck size={12}/> Tracker</div></th>
                                ...
                                filteredReports.map((row, index) => {
                                    ...
                                    return (
                                        <tr key={row.workbench_id || index} className="hover:bg-blue-50/50 transition">
                                           ...
                                           {/* whitespace-nowrap aur flex layout se text humesha straight single line me rahega */}
<td className="p-2 border-r border-gray-200 text-center whitespace-nowrap">
    <div className="flex flex-row flex-nowrap items-center justify-center gap-1 min-w-max">
        <span className="text-green-700 font-bold shrink-0">{row.package}</span>
        <span className="text-gray-300 mx-1 shrink-0">|</span>
        <span className="text-gray-800 font-black shrink-0">{row.requirement}</span>
    </div>
</td>
