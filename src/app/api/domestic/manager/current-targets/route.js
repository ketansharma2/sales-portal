...
// GET - Fetch current month's targets for domestic manager's FSEs and LeadGens with achievements
export async function GET(request) {
  try {
    ...
    // Fetch targets from domestic_sm_fse_targets for the month
    ...
    console.error('Domestic manager current targets GET error:', error)
    return NextResponse.json({
