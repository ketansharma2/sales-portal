...
export async function POST(request) {
  try {
    ...
    // Insert into domestic_sm_fse_targets table
    ...
    console.error('Domestic member targets POST error:', error)
    return NextResponse.json({
...
export async function GET(request) {
  try {
    ...
    console.error('Domestic member targets GET error:', error)
    return NextResponse.json({
      error: 'Internal server error',
      details: error.message
    }, { status: 500 })
...
export async function PUT(request) {
  try {
    ...
    console.error('Domestic member targets PUT error:', error)
    return NextResponse.json({
      error: 'Internal server error',
      details: error.message
    }, { status: 500 })
