...
export async function POST(request) {
  try {
    ...
    // Step 1: Fetch the client details from domestic_clients
    ...
    // Step 3: Insert into domestic_crm_clients
    ...
    // Step 4: Update domestic_clients
    ...
    if (updateError) {
      console.error('Update domestic clients error:', updateError)
