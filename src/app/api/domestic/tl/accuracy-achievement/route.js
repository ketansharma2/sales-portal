...
export async function GET(request) {
  try {
    ...
    console.log('TL Accuracy achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);
    ...
    console.log('TL Total tracker sent:', totalTrackerSent);
    console.log('TL CV matches:', cvMatches);
    console.log('TL Accuracy percentage:', accuracy);
    ...
    console.error('TL Accuracy achievement API error:', error);
    return NextResponse.json({
