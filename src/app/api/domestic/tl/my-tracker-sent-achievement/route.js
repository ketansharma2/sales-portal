...
export async function GET(request) {
  try {
    ...
    console.log('My Targets Tracker sent achievement - Month:', month, 'Year:', year, 'User ID:', currentUserId);
    ...
    console.log('My Targets Tracker sent data:', trackerSentData?.length || 0);

    if (trackerSentError) {
      console.error('My Targets Tracker sent fetch error:', trackerSentError);
    ...
    console.log('My Targets Tracker sent achieved:', achieved);
    ...
    console.error('My Targets Tracker sent achievement API error:', error);
    return NextResponse.json({
