...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('My Targets Joining achievement - Month:', month, 'Year:', year, 'User ID:', currentUserId);
    ...
    if (joiningError) {
      console.error('My Targets Joining fetch error:', joiningError);
    ...
    console.log('My Targets Joining achieved:', achieved);
    ...
    console.error('My Targets Joining achievement API error:', error);
    return NextResponse.json({
