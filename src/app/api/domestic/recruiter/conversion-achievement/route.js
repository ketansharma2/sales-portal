...
export async function GET(request) {
  try {
    ...
    console.log('Conversion achievement - Month:', month, 'Year:', year, 'User:', user.id);
    ...
    console.log('Conversion data:', conversionData?.length || 0);
    ...
    console.log('Conversion achieved:', achieved);
    ...
    console.error('Conversion achievement API error:', error);
    return NextResponse.json({
