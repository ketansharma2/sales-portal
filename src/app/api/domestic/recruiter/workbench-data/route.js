...
  try {
    // Get authenticated user from auth-helper (middleware headers)
...
    console.log('Recruiter Page - Workbench count:', workbenchData?.length || 0)
    console.log('Recruiter Page - Req IDs:', reqIds)
    console.log('Recruiter Page - Requirements found:', reqsData?.length || 0)
...
        console.log("ParsingIds:", parsingIds);
...
        // FIX: Deduplicate by parsing_id before counting
...
        }
      }
      console.log("portalCounts",conversationStats);
      return {
