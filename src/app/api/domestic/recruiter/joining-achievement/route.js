...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('Joining achievement - Month:', month, 'Year:', year, 'User:', user.id);
    ...
    console.log('Conversation IDs sent to CRM:', conversationIds.length);
    ...
    console.log('Joining achievements:', achieved);
    ...
    console.error('Joining achievement API error:', error);
    return NextResponse.json({
