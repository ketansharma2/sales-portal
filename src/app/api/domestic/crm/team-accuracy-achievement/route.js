...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('CRM Team Accuracy achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);
    ...
    if (accuracyError) {
      console.error('CRM Team Accuracy fetch error:', accuracyError);
    ...
    console.log('CRM Team Accuracy achieved:', achieved);
    ...
    console.error('CRM Team Accuracy achievement API error:', error);
    return NextResponse.json({
