...
export async function GET(request) {
  try {
    ...
    console.log('CRM Team Conversion achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);

    // Count conversion records for users under the assigned person (if they're a TL)
    ...
    console.log('CRM Team Conversion achieved:', achieved);
    ...
    console.error('CRM Team Conversion achievement API error:', error);
    return NextResponse.json({
