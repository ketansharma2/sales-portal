...
console.error('Fetch domestic CRM client error:', clientError)
...
if (emailError) {
console.error('Fetch domestic CRM emails error:', emailError)
return NextResponse.json({
...
if (interviewError) {
console.error('Fetch domestic CRM interviews error:', interviewError)
return NextResponse.json({
