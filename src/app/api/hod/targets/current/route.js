...
// GET /api/hod/targets/current - Fetch targets for current month
export async function GET(request) {
  try {
    ...
    // Get existing targets for the current month
    ...
    console.error('HOD targets current GET error:', error)
    return NextResponse.json({
