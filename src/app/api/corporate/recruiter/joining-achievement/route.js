...
export async function GET(request) {
  try {
    ...
    console.log('Corporate Joining achievement - Month:', month, 'Year:', year, 'User:', user.id);
    ...
    if (sentToCrmError) {
      console.error('Corporate sent to CRM fetch error:', sentToCrmError);
    ...
    console.log('Corporate conversation IDs sent to CRM:', conversationIds.length);
    ...
    // Step 2: Get email draft IDs from corporate_crm_emails
    ...
    if (emailError) {
      console.error('Corporate email data fetch error:', emailError);
    ...
    console.log('Corporate email draft IDs found:', emailDraftIds.length);
    ...
    if (joiningError) {
      console.error('Corporate joining data fetch error:', joiningError);
    ...
    console.log('Corporate joining achievements:', achieved);
    ...
    console.error('Corporate joining achievement API error:', error);
    return NextResponse.json({
