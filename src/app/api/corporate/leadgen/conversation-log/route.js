...
export async function GET(request) {
  try {
    ...
    const isLeadgen = userProfile.role && userProfile.role.includes('LEADGEN');
    const isManager = userProfile.role && userProfile.role.includes('MANAGER');

    if (!isLeadgen && !isManager) {
