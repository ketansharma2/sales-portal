...
export async function GET(request) {
  try {
    ...
    // Filter by franchise_status = "form filled" (case-insensitive)
    ...
    // Step 1: Find first interaction for each client_id (first time they got "form filled")
    ...
    const totalFranchiseAccepted = formattedInteractions.length;
