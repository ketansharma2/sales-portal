...
// GET - Fetch past months' targets for corporate manager's FSEs and LeadGens with achievements
export async function GET(request) {
  try {
    ...
    // Fetch targets from corporate_sm_fse_targets for past months
    ...
    console.error('Corporate manager history targets GET error:', error)
    return NextResponse.json({
