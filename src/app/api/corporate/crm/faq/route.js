...
// GET - Fetch all FAQs for the logged-in user
export async function GET(request) {
  try {
    ...
    // Get unique client_ids and req_ids
    ...
    // Transform data with joined data
...
export async function POST(request) {
  try {
    ...
    // Check if FAQ already exists for this client_id and req_id
