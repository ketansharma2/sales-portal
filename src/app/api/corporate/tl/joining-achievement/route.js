...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('Corporate TL Joining achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);
    ...
    console.log('Corporate TL Conversation IDs sent to CRM:', conversationIds.length);
    ...
    console.log('Corporate TL Email draft IDs found:', emailDraftIds.length);
    ...
    console.log('Corporate TL Joining achievements:', achieved);
    ...
    console.error('Corporate TL Joining achievement API error:', error);
    return NextResponse.json({
