...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('Corporate TL Tracker sent achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);
    ...
    console.log('Corporate TL Tracker sent data:', trackerSentData?.length || 0);
    ...
    console.log('Corporate TL Tracker sent achieved:', achieved);
    ...
    console.error('Corporate TL Tracker sent achievement API error:', error);
    return NextResponse.json({
