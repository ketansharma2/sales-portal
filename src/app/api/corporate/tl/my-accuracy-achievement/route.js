...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('Corporate My Targets Accuracy achievement - Month:', month, 'Year:', year, 'User ID:', currentUserId);
    ...
    if (accuracyError) {
      console.error('Corporate My Targets Accuracy fetch error:', accuracyError);
    ...
    console.log('Corporate My Targets Accuracy achieved:', achieved);
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        details: {
          ...
          successfulInterviews: achieved
        }
      }
    });

  } catch (error) {
    console.error('Corporate My Targets Accuracy achievement API error:', error);
    return NextResponse.json({
