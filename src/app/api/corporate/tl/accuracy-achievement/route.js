...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('Corporate TL Accuracy achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);
    ...
    console.log('Corporate TL Total tracker sent:', totalTrackerSent);
    console.log('Corporate TL CV matches:', cvMatches);
    console.log('Corporate TL Accuracy percentage:', accuracy);
    ...
    console.error('Corporate TL Accuracy achievement API error:', error);
    return NextResponse.json({
