...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('Corporate TL CV Parse achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);
    ...
    console.log('Corporate TL CV parse data:', cvParseData?.length || 0);
    ...
    console.log('Corporate TL CV parse achieved:', achieved);
    ...
    console.error('Corporate TL CV Parse achievement API error:', error);
    return NextResponse.json({
