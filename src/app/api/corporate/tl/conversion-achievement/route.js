...
if (authError || !user) {
  ...
  return NextResponse.json({ success: false, error: 'Unauthorized' }, { status: 401 });
    ...
    console.log('Corporate TL Conversion achievement - Month:', month, 'Year:', year, 'Assigned To:', assignedToId);
    ...
    console.log('Corporate TL Conversion data:', conversionData?.length || 0);
    ...
    console.log('Corporate TL Conversion achieved:', achieved);
    ...
    console.error('Corporate TL Conversion achievement API error:', error);
    return NextResponse.json({
